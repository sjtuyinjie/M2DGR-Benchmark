...
public:
                                          ...
                                          const vector<geometry_msgs::Point32> &features_2d)
    {
        ...
        try
        {
            listener.waitForTransform("world", "vins_body_ros", stamp_cur, ros::Duration(0.01));
            listener.lookupTransform("world", "vins_body_ros", stamp_cur, transform); // get wolrd^T_lidar
        }
